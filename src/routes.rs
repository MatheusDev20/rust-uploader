...
use crate::handlers::resources::{new_resource_handler, list_resource_types, search_resources_handler};
...
pub fn init_routes(state: AppState) -> Router {
    ...
    Router::new()
        ...
        .route("/resources/search", get(search_resources_handler))
        .route("/resource-types", get(list_resource_types))
